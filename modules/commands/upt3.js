...
let l1 = await loadImage(pathAva);
  ...
  ctx.drawImage(l1, 800, -160, 1100, 1100);
    ...
    ctx.fillText("Nắng Mùa Thu", 95, 340);
    ctx.beginPath();
  ////////////////////////////////////////
...
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.fillText("@" + "Nắng Mùa Thu", 250, 575)
