...
module.exports.generatePicture = function (hunterID, victimID) {
	return new Promise(async (resolve, reject) => {
		try {
			...
			const hunterAva = await loadImage(`https://graph.facebook.com/${hunterID}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`);
			const victimAva = await loadImage(`https://graph.facebook.com/${victimID}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`);
